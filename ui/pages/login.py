...
def render() -> None:
    ...
    # After a prior form submit, session state has the username — sync before drawing radios.
    if (st.session_state.get("login_username_input") or "").strip():
        ...
        if submitted:
            ...
            if not username:
                ...
                if not user_payload:
                    ...
                    login_user(user_payload, portal=portal)
